...
function ExperienceEducation() {
  return (
    <section
      id="experience"
      className="py-20 px-6 bg-gradient-to-br from-[#021e21] via-[#030406] to-[#021e21] text-white"
    >
      <div className="max-w-6xl mx-auto bg-white/10 backdrop-blur-xl p-10 rounded-3xl shadow-lg">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold text-orange-500 font-titillium">Experience</h3>
            ...
            {[
              ...
              >
                <h4 className="font-bold text-lg text-orange-500 font-titillium">{exp.role}</h4>
          ...
          {/* Education */}
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold text-pink-400 font-titillium">Education</h3>
            ...
            {[
              ...
              >
                <h4 className="font-bold text-lg text-pink-400 font-titillium">{edu.course}</h4>
